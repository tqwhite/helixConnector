...
https.get(`${URL}/hxGetViewSummary?nativeRelationName=${relationName}&viewName=${viewName}`, {
  "headers": {
    "accept": "*/*",
    "accept-language": "en-US,en;q=0.9",
    "authorization": "tq@justkidding.com eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOiJ0cUBqdXN0a2lkZGluZy5jb20iLCJpbnN0YW5jZUlkIjoidHF3aGl0ZS9xYm9vayIsImlhdCI6MTQ0OTk2NTY2NX0.9-fcamt3HRF2kK9Kmtb4u8Rd3FGj7V8HfLenvijWF_E aquaSeachem/getConfig",
...
const mappingListGen = fieldData => {
	...
	return fieldData.reduce((result, item) => ({...result, [(item.meta.customName ? item.meta.customName : item.meta.nativeName)]:mappingLookup.qtGetSurePath(item.meta.fieldType, 'StringType')}), {});
};
