...
//	getMainElementStuff({ log, driverParameterReplaceObject });
	log(`done with operateSpecialElement`);
	...
	const generateEndpoint = require('./elementFormatter');

	const finishedEndpoint = generateEndpoint({
		mainElements,
		separators,
		log
	});
